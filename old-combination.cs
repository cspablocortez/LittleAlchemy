...
public class combination : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        Debug.Log(gameManager.Instance.productTag);
        uiManager.EnableButtonByTag(gameManager.Instance.productTag);
    ...
    public string CombineElements(combination otherElement)
    {
         ...
         (this.CompareTag("steam generator") && otherElement.CompareTag("electric")))
        {
            ...
            Debug.Log("debug of combined element prefab : " + combinedElementPrefab.tag);
